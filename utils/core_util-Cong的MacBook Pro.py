...
def clam_runner(args, model, data, label, loss_fn, instance_eval=True, return_lgt=False, return_feature=False, return_sfm=False, custom_input=None, raw_image=False):
    if raw_image:
...
def transmil_runner(model, data, label, loss_fn):
    data = data.unsqueeze(0)
...
def abmil_runner(model, data, label, loss_fn):
